 ...
 if (isset($_GET['id'])) {
    if ($_GET['id']>0){
        ...
        if (isset($_GET['Nombre'])) {
          $sql1 = "UPDATE `cotiza` SET `Nombre` = '".$_GET["Nombre"]."' WHERE id=".$_GET['id'].";";
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" novalidate method="get" action="nombre.php">
                        <input type="hidden" name="id" id="id" value="<?php echo $idid; ?>">
                            <div class="col-md-10 form-floating mb-3 mt-3">
                               <input class="form-control" type="text" name="Nombre" id="Nombre" placeholder="Nombre Empresa" value="<?php echo $Nombre; ?>" required>
